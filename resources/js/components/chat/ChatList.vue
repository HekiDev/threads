...
<template>
    ...
    >
        ...
        <div class="truncate text-ellipsis break-all w-full">
            ...
            <p class="text-sm truncate text-ellipsis break-all"
                :class="{
                    'text-muted-foreground' : isClicked || (chat.last_message.is_mine || chat.last_message.status === 'read'),
                }"
            >
